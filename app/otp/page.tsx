    ...
    <div className="min-h-screen bg-[#1C1C2E] flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-10">
        <div className="text-center mb-10">
          ...
          <p className="text-[#6F5333] font-semibold text-base mt-1">c***@email.com</p>
        </div>
        ...
        <div className="flex gap-3 justify-center mb-8">
          {[1,2,3,4,5,6].map((i) => (
            <input
              ...
              inputMode="numeric"
              maxLength={1}
              className="w-14 h-16 border-2 border-gray-200 rounded-2xl text-3xl font-bold text-center focus:outline-none focus:border-[#6F5333] transition-colors text-gray-800"
            />
          ))}
        </div>

        <button className="w-full bg-[#6F5333] hover:bg-[#5A4228] text-white text-xl font-bold py-5 rounded-2xl transition-colors shadow-lg mb-5">
          Verifikasi
        </button>

        <div className="text-center space-y-3">
          <p className="text-gray-500 text-base">Belum menerima kode?</p>
          <button className="text-[#6F5333] text-lg font-semibold hover:underline">
