  ...
  return (
    ...
    >
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "7pt", marginBottom: "7pt" }}>
        <thead>
          <tr style={{ backgroundColor: "#fff", color: "#000" }}>
            {[
              ...
              { label: "Kadar",       w: "40pt", align: "center" as const },
              { label: "Berat",       w: "45pt", align: "center" as const },
              { label: "Harga/Gram",  w: "58pt", align: "right"  as const },
              { label: "Total",       w: "63pt", align: "right"  as const },
            ].map((h) => (
        ...
        <tbody>
          <tr>
            <td style={{ padding: "4.5pt 5.5pt", border: `0.5pt solid ${INVOICE_GOLD_LT}`, textAlign: "center" }}>1</td>
            <td style={{ padding: "4.5pt 5.5pt", border: `0.5pt solid ${INVOICE_GOLD_LT}` }}>
              {data.nama_barang}{data.jumlah > 1 ? ` (×${data.jumlah})` : ""}
            </td>
            <td style={{ padding: "4.5pt 5.5pt", border: `0.5pt solid ${INVOICE_GOLD_LT}`, textAlign: "center" }}>{data.kadar}</td>
            <td style={{ padding: "4.5pt 5.5pt", border: `0.5pt solid ${INVOICE_GOLD_LT}`, textAlign: "center" }}>{fmtGram(totalBerat)}</td>
            <td style={{ padding: "4.5pt 5.5pt", border: `0.5pt solid ${INVOICE_GOLD_LT}`, textAlign: "right" }}>{fmtRupiah(data.harga_per_gram)}</td>
            <td style={{ padding: "4.5pt 5.5pt", border: `0.5pt solid ${INVOICE_GOLD_LT}`, textAlign: "right", fontWeight: 700 }}>{fmtRupiah(data.total)}</td>
          </tr>
      ...
      <div style={{ fontSize: "6.5pt", marginBottom: "5.5pt" }}>
        <div style={{ fontWeight: 900, fontSize: "7pt", marginBottom: "3pt" }}>KETENTUAN BUYBACK TOKO EMAS :</div>
